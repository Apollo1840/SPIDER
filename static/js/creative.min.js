...
function myFunction() {
    var y = document.getElementById("spider-loader");
    ...
    setTimeout(function(){
    var z = document.getElementById("spider-loader");
 ...
 if(key == 13)  // the enter key code
  {
   var name = document.getElementById("name").value
    ...
    $("#contact-chips").append("<div class='chip'>" + name + "<span class='closebtn' onclick='this.parentElement.style.display='none'>&times;</span></div>");
    $("#name").val('');}
}); 
